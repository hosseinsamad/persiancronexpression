 ...
 */
public class PersianCronTrigger extends Trigger {
     ...
     */
    private static final long serialVersionUID = -3831854792961967025L;
    ...
    private static final int YEAR_TO_GIVEUP_SCHEDULING_AT = 1720;//2099 + 200 = 2299, for jalali: 1520 + 200 = 1720 (formula: upperbound + 200)
    ...
    private PersianCronExpression cronEx = null;
     ...
     * </p>
     */
    public PersianCronTrigger(String name, String group) {
        super(name, group);
        setStartTime(new Date());
        setTimeZone(TimeZone.getDefault());
    }
     ...
     * </p>
     */
    public PersianCronTrigger(String name, String group, String cronExpression)
     ...
     * </p>
     */
    public PersianCronTrigger(String name, String group, String jobName,
            String jobGroup) {
    ...
    public Object clone() {
        PersianCronTrigger copy = (PersianCronTrigger) super.clone();
        if (cronEx != null) {
            copy.setPersianCronExpression((PersianCronExpression)cronEx.clone());
        }
        return copy;
    }
    ...
    public void setCronExpression(String cronExpression) throws ParseException {
        ...
        this.cronEx = new PersianCronExpression(cronExpression);
     ...
     * @param cronExpression
     */
    public void setPersianCronExpression(PersianCronExpression cronExpression) {
    ...
    public void updateWithNewCalendar(org.quartz.Calendar calendar, long misfireThreshold)
    {
        ...
        while (nextFireTime != null && !calendar.isTimeIncluded(nextFireTime.getTime())) {
            ...
            //avoid infinite loop
            com.ibm.icu.util.Calendar c = PersianUtils.getCalendarInstance();
            c.setTime(nextFireTime);
            if (c.get(com.ibm.icu.util.Calendar.YEAR) > YEAR_TO_GIVEUP_SCHEDULING_AT) {
                nextFireTime = null;
            }
    ...
    public static void main(String[] args) // TODO: remove method after good
        ...
        PersianCronTrigger ct = new PersianCronTrigger("t", "g", "j", "g", new Date(), null, expr);
...
////
////        PersianCronTrigger trigger = new PersianCronTrigger();
////
...
////
////        trigger = new PersianCronTrigger();
////
