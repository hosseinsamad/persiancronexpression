...
import org.quartz.PersianCronExpression;
 ...
 * @author Aaron Craven
 */
public class PersianCronCalendar extends BaseCalendar {
    static final long serialVersionUID = -6183952454488890877L;

    /** @deprecated The use of <code>name</code> is no longer supported. */
    private String name;
    
    PersianCronExpression cronExpression;
     ...
     */
    public PersianCronCalendar(String expression) 
     ...
     * @param expression   a String representation of the desired cron expression
     */
    public PersianCronCalendar(Calendar baseCalendar,
    ...
    public PersianCronCalendar(Calendar baseCalendar,
        ...
        super(baseCalendar);
        this.cronExpression = new PersianCronExpression(expression);
     ...
     */
    public PersianCronCalendar(String name, String expression) 
        throws ParseException {
        this(expression);
        this.name = name;
    }
     ...
     */
    public PersianCronCalendar(String name, Calendar baseCalendar,
            String expression) throws ParseException {
     ...
     */
    public PersianCronExpression getCronExpression() {
    ...
    public void setCronExpression(String expression) throws ParseException {
        PersianCronExpression newExp = new PersianCronExpression(expression);
     ...
     */
    public void setCronExpression(PersianCronExpression expression) {
        if (expression == null) {
